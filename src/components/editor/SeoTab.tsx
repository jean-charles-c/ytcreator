...
import { Youtube, Loader2, Trophy } from "lucide-react";
...
export default function SeoTab({ projectId, analysis, extractedText }: SeoTabProps) {
  ...
  return (
    <div className="container max-w-3xl py-6 sm:py-10 px-4 animate-fade-in">
      ...
      <p className="text-sm text-muted-foreground mb-6 sm:mb-8">
        Générez des titres YouTube optimisés à partir de l'analyse narrative.
      </p>
        ...
        <>
          ...
          {youtubeTitles && (
            <div className="rounded-lg border border-border bg-card p-4 sm:p-6 animate-fade-in">
              ...
              <div className="mt-4">
                <Button variant="outline" onClick={() => { setYoutubeTitles(null); }} className="min-h-[44px]">
                  <Youtube className="h-4 w-4" /> Régénérer les titres
                </Button>
              </div>
            </div>
          )}
