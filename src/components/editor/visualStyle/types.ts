...
export const VISUAL_STYLES: VisualStyleOption[] = [
  ...
  { id: "lineart", label: "Dessin / Line art", promptSuffix: "Pencil sketch portrait, graphite drawing, crosshatching, black and white, realistic editorial illustration, sketched background, fine detailed linework" },
